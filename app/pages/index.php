...
<body class="select-none">
    ...
    <footer class="bg-white shadow-lg dark:bg-gray-900">
        <div class="w-full max-w-screen-xl p-4 py-6 mx-auto lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="../../public/assets/Logo.svg" class="flex items-center">
                        <img src="../../public/assets/Logo.svg" class="w-24 h-24 me-3" alt="Logo RocketStore" />
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="font-medium text-gray-500 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="https://github.com/fakersl/" class="hover:underline ">Github</a>
                            </li>
                            <li>
                                <a href="#" class="hover:underline">,,,</a>
                            </li>
                    ...
                    <div>
                        ...
                        <ul class="font-medium text-gray-500 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="../admin/pages/politica-de-privacidade.php" class="hover:underline">Política de Privacidade</a>
                            </li>
                            <li>
                                <a href="../admin/pages/termos-e-condicoes.php" class="hover:underline">Termos &amp; Condições</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#"
                        class="hover:underline">RocketStore™</a>. Todos os direitos
                    reservados.
                </span>
