        ...
        <nav class="fixed top-0 z-50 w-full p-4 bg-white border-b border-gray-200 shadow-md start-0">
            <div class="flex items-center justify-between pb-3">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="#" class="relative w-6 h-6" id="icon-sacola">
                        ...
                        <span
                            class="absolute top-0 right-0 inline-flex items-center justify-center hidden w-4 h-4 text-xs font-bold text-white bg-red-600 rounded-full badge">0</span>
                    </a>
...
<!--                     <div id="sidebar"
                        ...
                        <div class="p-4">
                            ...
                            <ul class="mt-6 space-y-4">
                                <li><a href="./femininos.php"
                                        class="font-semibold text-gray-900 hover:text-purple-700">Feminino</a>
                                </li>
                                <li><a href="./masculinos.php"
                                        class="font-semibold text-gray-900 hover:text-purple-700">Masculino</a></li>
                                <li><a href="#" class="font-semibold text-gray-900 hover:text-purple-700">Promoções</a>
                                </li>
                                <li><a href="#" class="font-semibold text-gray-900 hover:text-purple-700">Mystery
                                        Boxes</a></li>
                            </ul>
