...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['imagemProduto']) && $_FILES['imagemProduto']['error'] == 0) {
        ...
        if (move_uploaded_file($_FILES['imagemProduto']['tmp_name'], $caminhoCompleto)) {
            ...
            $stmt->bind_param("sdsssis", $nomeProduto, $precoProduto, $categoriaProduto, $marcaProduto, $nomeArquivo, $fkIdFornecedor, $fkIdColecao);
                ...
                <li>
                    ...
                    <div id="dropdown-produtos" class="hidden mt-2 space-y-2">
                        ...
                        <a href="./CRUD/listar_produtos.php"
                            ...
                            de Produtos</a>
                        <a href="#"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Categorias</a>
                    </div>
                </li>
