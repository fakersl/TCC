                        ...
                        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div class="w-full h-56">
                                <a href="produtoOverview.php?idProduto=<?php echo $produto['idProduto']; ?>">
                                    <img class="h-full mx-auto dark:hidden" src="<?php echo $imagemProduto; ?>" alt="<?php echo $produto['nomeProduto']; ?>">
                                    <img class="hidden h-full mx-auto dark:block" src="<?php echo $imagemProduto; ?>" alt="<?php echo $produto['nomeProduto']; ?>">
                                </a>
                            </div>
                            <div class="pt-6">
                                ...
                                <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white"><?php echo $produto['nomeProduto']; ?></a>
                                <div class="flex items-center gap-2 mt-2">
                                    <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">R$<?php echo number_format($produto['precoProduto'], 2, ',', '.'); ?></p>
