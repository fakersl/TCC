                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        <button type="button"
                            ...
                            aria-expanded="false" onclick="toggleDropdown('dropdown-produtos', 'arrow-produtos')">
                    ...
                    <li>
                        ...
                        <button type="button"
                            ...
                            aria-expanded="false" onclick="toggleDropdownIcon('dropdown-colecoes-icon')">
                    ...
                    <li>
                        ...
                        <button type="button"
                            ...
                            <svg id="dropdown-fornecedores-icon"
                                class="w-3 h-3 transition-transform duration-300 transform" aria-hidden="true"
